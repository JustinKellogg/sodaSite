...
DATABASES = {
    'default': {
        ...
        'NAME': 'SodaDB.db',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': '',
        'PASSWORD': '',
        'HOST': 'http://ec2-54-245-61-23.us-west-2.compute.amazonaws.com',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = '5^260gukz&yueb_*@@*y!r8d=+2%qukctn1pz#b7lx=4#s!k_%'
